import { AddCircle, ArrowBack, Cancel, Task, SkipNext } from "@mui/icons-material";
  ...
  return (
    <div className="w-1/3 p-8 relative">
      ...
      <div className="w-11/12 flex items-center gap-3 absolute bottom-2 mx-auto right-0 left-0">
        ...
        <button className="flex bg-sky-500 items-center justify-center rounded-sm text-white w-1/4 h-12 hover:opacity-50 " onClick={() => setOpen(false)}>
          <span className="text-lg mr-2">skip save</span>
          <SkipNext></SkipNext>
        </button>
        <button className="flex bg-orange-500 items-center justify-center rounded-sm text-white w-1/4 h-12 hover:opacity-50" onClick={handleSave}>
