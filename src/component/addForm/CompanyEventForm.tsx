...
import TaskFlow from "../addTaskForm/TaskFlow";
...
interface CompanyEventFormProps {
  ...
  setNewPostId:  React.Dispatch<React.SetStateAction<string>>,
}

const CompanyEventForm = ({setTranslateY, setOpen, setNewPostId}: CompanyEventFormProps) => {
  ...
  return (
    <div className="w-1/3 p-8 relative">
      ...
      <div className="flex flex-col w-full h-auto lg:full gap-6 ml-3 mb-20">
        ...
        <label htmlFor="event">
          イベント：
          <select className="bg-gray-50 shadow-inner border-2 rounded-md w-3/5" ref={eventRef}>
